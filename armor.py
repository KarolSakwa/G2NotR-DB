...
class Armor:
    ...
    def get_file_content(self):
        return open('.\\game_content\\Items\\IT_Armor.d', 'r').read().lower() if self.instance in open('.\\game_content\\Items\\IT_Armor.d', 'r').read().lower() else open('.\\game_content\\Items\IT_Addon_Armor.d', 'r').read().lower()
...
armor_file = open('.\\game_content\\Items\\IT_Armor.d', 'r').read().lower()
addon_armor_file = open('.\\game_content\\Items\\IT_Addon_Armor.d', 'r').read().lower()
